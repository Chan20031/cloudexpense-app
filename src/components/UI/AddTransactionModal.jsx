        ...
        <div className="p-6">
          ...
          {isProcessingReceipt && (
            <div className="p-3 rounded-lg mb-4 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-800 flex items-center gap-2">
              ...
              Processing receipt with AWS Textract...
            </div>
          )}
            ...
            {transactionType === 'expense' && (
              <div>
                  ...
                  <input
                    ...
                    onChange={async (e) => {
                      ...
                      if (!allowedTypes.includes(file.type)) {
                        setReceiptError('Please select a JPEG, PNG, or PDF file only.');
                        e.target.value = '';
                      ...
                      try {
                        ...
                        setMessage({ 
                          type: 'success', 
                          text: result.message || 'Receipt processed successfully!' 
                        });
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                  Accepted: JPEG, PNG, PDF • Max size: 1MB
                </div>
